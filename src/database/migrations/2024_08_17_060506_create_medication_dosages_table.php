...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('medication_dosages', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('glucose_records_id')->default(0)->index('fk_medication_dosages_glucose_records')->comment('血糖値記録ID');
            $table->unsignedBigInteger('medication_id')->default(0)->index('fk_medication_dosages_medication_settings')->comment('薬ID');
